...
public class NoteManager {
    ...
    private void setupCourses() {
        mCourse.add(new Course(1, "Java"));
        mCourse.add(new Course(2, "Android Programming"));
        mCourse.add(new Course(3, "Intro to Programming"));
        mCourse.add(new Course(4, "Swift"));
        mCourse.add(new Course(5, "C & Objective C"));
        mCourse.add(new Course(6, "IOS Programming"));
    }
