...
public class QuizActivity extends AppCompatActivity {
    ...
    private int mCheatTokenCount = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateQuestion();
        mCheatTokensTextView = findViewById(R.id.cheat_token_count);
        mCheatTokensTextView.setText(Integer.toString(mCheatTokenCount));
